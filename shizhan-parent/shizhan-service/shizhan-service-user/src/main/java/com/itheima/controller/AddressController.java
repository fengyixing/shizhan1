...
public class AddressController {
    ...
    public Result<List<Address>> findByUsername(@PathVariable("username") String username) {
        // 调用service根据用户名查询地址列表
    ...
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "Integer")
    @PutMapping(value="/{id}")
    public Result update(@RequestBody @ApiParam(name = "Address对象",value = "传入JSON数据",required = false) Address address,@PathVariable("id") Integer id){
        //设置主键值
        address.setId(id);
